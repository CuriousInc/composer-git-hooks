...
abstract class TestCase extends PHPUnitTestCase
{
    ...
    public static function createHooks($gitDir = '.git', $createLockFile = false, $lockDir = false): void
    {
    ...
    public static function createTestComposerFile($dir = '.', $hooks = []): void
    {
    ...
    public static function removeTestComposerFile($dir = '.'): void
    {
